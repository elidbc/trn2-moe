...
def main():
    ...
    s3_prefix = "compiled_model_weights"
    ...
    with torch.no_grad(): 
        for input_path in input_files:
            ...
            local_save_name = f"../weights/compiled_model_weights/compiled_moe_{filename}.pt"
            s3_key = f"{s3_prefix}/compiled_moe_{filename}.pt"
